...
if($_SESSION["role"] !== "Challenger"){
    ...
    if (isset($_SESSION['mySession']) && isset($con)) {
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            $challengerID = isset($row['user_id']) ? $row['user_id'] : $challengerID;
        }
    }
?>
...
<head> 
    ...
    <title>Challenger-Profile</title>

     <link rel="preconnect" href="https://fonts.googleapis.com">
<link rel="preconnect" href="https://fonts.gstatic.com" crossorigin>
<link href="https://fonts.googleapis.com/css2?family=Josefin+Sans:ital,wght@0,100..700;
1,100..700&family=Nunito+Sans:ital,opsz,wght@0,6..12,200..1000;1,6..12,200..1000&family=Open+Sans:ital,
...
<body>
    ...
    <main> 
        <div class="top-row">
            ...
            <button class="btn-edit" onclick="window.location.href='challengerEditProfile.php'">EDIT</button>
        </div>

      <div class="profile-pic-container">
            <img src="../images/Profile Picture.jpg" alt="Profile Picture" class="profile-pic"> 
        </div>

        <div class="info-section">
            <div class="gray-box row-top">
                <?php echo $name; ?> | Challenger ID: <?php echo $challengerID; ?> | Challenger
            </div>
