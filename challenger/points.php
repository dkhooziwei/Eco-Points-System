    ...
    <style>
        ...
        * {
        ...
        @media(max-width:900px){
            .title,.search_container,.recycling_center{
                display: none;
            }
            .points{
                margin: 0 auto;
...
<body>
    ...
    <div class = "content">
        ...
        <div class = "search_container">
            ...
            <a href = "points.php" style = "text-decoration: none;">
                <button class="point_bar">
                        Points Chart
                </button>
            </a>
        ...
        <div class="points">
            <a href = "viewRecyclingInfo.php" style = "text-decoration: none;">
