...
if($_SESSION["role"] !== "Admin"){
    ...
    if (isset($_SESSION['mySession']) && isset($con)) {
        ...
        if ($row = $result->fetch_assoc()) {
            ...
            $adminID = isset($row['user_id']) ? $row['user_id'] : $adminID;
        }
    }
?>
...
<body>
   ...
   <?php include 'adminTaskbar.php'; ?>
    ...
    <main> 
        <div class="top-row">
            <h1>Admin Profile</h1>
            <button class="btn-edit" onclick="window.location.href='adminEditProfile.php'">EDIT</button>
        </div>
        ...
        <div class="info-section">
            <div class="gray-box row-top">
                <?php echo $name; ?> | Admin ID: <?php echo $adminID; ?> | ADMIN 
            </div>
