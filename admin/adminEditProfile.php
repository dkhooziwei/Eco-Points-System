...
if (isset($_POST['updateBtn'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Profile Updated Successfully!'); window.location.href='admin Profile Page.php';</script>";
    } else {
            ...
            <div class="registration-form-container">
                <form method="post" action="">
                    ...
                    <div class="button-row">
                        ...
                        <a href="admin Profile Page.php" class="btn btn-cancel">Cancel</a>
                    </div>
