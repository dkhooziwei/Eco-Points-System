...
if ($result->num_rows > 0) {
    ...
    echo "<script>alert('User not found!'); window.location.href='challengerEditProfile.php';</script>";
    exit();
}
...
if (isset($_POST['updateBtn'])) {
    ...
    if ($stmt->execute()) {
        echo "<script>alert('Profile Updated Successfully!'); window.location.href='challenger Profile Page.php';</script>";
    } else {
            ...
            <div class="registration-form-container">
                <form method="post" action="">
                    ...
                    <div class="button-row">
                        ...
                        <a href="challenger Profile Page.php" class="btn btn-cancel">Cancel</a>
                    </div>
